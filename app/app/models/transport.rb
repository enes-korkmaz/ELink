...
class Transport < ApplicationRecord
    ...
    has_one_attached :quotation_document
    has_one_attached :invoice_document

    validates :company_name, :transport_type, :status, presence: true
    validates :status, inclusion: { in: [ "in Bearbeitung", "angefragt", "gebucht" ] }
