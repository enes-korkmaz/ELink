...
class UpdateExpertsFields < ActiveRecord::Migration[7.2]
  def change
    remove_column :experts, :salary

    change_column_null :experts, :name, false
    change_column_null :experts, :email, false
    change_column_null :experts, :phone_number, false
    change_column_null :experts, :origin, false
    change_column_null :experts, :travel_willingness, false
    change_column_null :experts, :institution, false
  end
end
