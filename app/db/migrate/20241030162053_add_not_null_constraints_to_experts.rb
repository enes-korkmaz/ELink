...
class AddNotNullConstraintsToExperts < ActiveRecord::Migration[7.2]
  def change
    change_column_null :experts, :last_name, false
    change_column_null :experts, :hourly_rate, false, 0
    change_column_null :experts, :daily_rate, false, 0
  end
end
