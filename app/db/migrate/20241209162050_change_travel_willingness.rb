...
class ChangeTravelWillingness < ActiveRecord::Migration[7.2]
  def change
    change_column_null :experts, :travel_willingness, true
    rename_column :experts, :travel_willingness, :travel_willingness_text
    add_column :experts, :travel_willingness, :integer, default: 0, null: false
  end
end
