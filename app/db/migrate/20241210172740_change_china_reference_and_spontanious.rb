...
class ChangeChinaReferenceAndSpontanious < ActiveRecord::Migration[7.2]
  def change
    remove_column :experts, :china_reference
    remove_column :experts, :spontaneous

    add_column :experts, :china_reference, :string
    add_column :experts, :spontaneous, :string
  end
end
