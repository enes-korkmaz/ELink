...
class MakeMandatoryChinaReferenceAndSpontanious < ActiveRecord::Migration[7.2]
  def change
    change_column_null :experts, :china_reference, false
    change_column_null :experts, :spontaneous, false
  end
end
