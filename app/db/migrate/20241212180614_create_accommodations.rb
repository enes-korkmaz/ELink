...
class CreateAccommodations < ActiveRecord::Migration[7.2]
  def change
    create_table :accommodations do |t|
      t.references :project, null: false, foreign_key: true
      t.string :name
      t.string :status, comment: "Status: in Bearbeitung / angefragt / gebucht"
      t.timestamp :booking_deadline
      t.json :address, comment: "Address details as JSON"
      t.json :contact, comment: "Contact details as JSON"
      t.text :notes
      t.datetime :gendate
      t.datetime :moddate
